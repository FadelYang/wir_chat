      ...
      <div className="sticky top-0 z-10 px-5 py-5 bg-white border border-b-gray-300 md:px-20 ">
        <div className='container flex mx-auto'>
          ...
          <div className='flex items-center ms-auto'>
            <button onClick={clearChat} className='px-5 py-2 text-xs text-white bg-black hover:bg-gray-900 md:text-sm rounded-xl hover:cursor-pointer'>Mulai Chat Baru</button>
